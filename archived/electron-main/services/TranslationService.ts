...
import type { BatchTranslationItem, SupportedLanguage, TranslationResult } from '../../shared/types'
...
export class TranslationService {
  ...
  private loadCacheFromDB(): void {
    try {
      const rows = this.db
        .prepare(
          'SELECT cache_key, translation FROM translation_cache ORDER BY created_at DESC LIMIT 5000'
        )
